...
COPY ModifyElectedOffices FROM stdin USING DELIMITERS '|';
101|Mayor|Santa Cruz|CA
105|Deputy Governor|Tampa|FL
108|Sheriff|Los Angeles|CA
103|Secretary of State|\N|NC
109|Chairman|Seattle|WA
110|Comptroller|Austin|TX
\.
